...
public class RussianFragment extends Fragment implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener, MyAdapter.itemClickListener {
    ...
    public void getData() {
        ...
        CollectionReference enterntainment = db.collection("russia");
        ...
        query.addSnapshotListener(new EventListener<QuerySnapshot>() {
            ...
            public void onEvent(@Nullable QuerySnapshot queryDocumentSnapshots, @Nullable FirebaseFirestoreException e) {
                ...
                if (!Topic.isEmpty()) {
                    ...
                    adapter.setClickListener(RussianFragment.this);
