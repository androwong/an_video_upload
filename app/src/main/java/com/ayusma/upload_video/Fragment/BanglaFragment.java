...
public class BanglaFragment extends Fragment implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener, MyAdapter.itemClickListener {
    ...
    public void getData() {
        ...
        CollectionReference enterntainment = db.collection("bangla");
        ...
        query.addSnapshotListener(new EventListener<QuerySnapshot>() {
            ...
            public void onEvent(@Nullable QuerySnapshot queryDocumentSnapshots, @Nullable FirebaseFirestoreException e) {
                ...
                if (!Topic.isEmpty()) {
                    ...
                    adapter.setClickListener(BanglaFragment.this);
