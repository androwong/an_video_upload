...
public class MovieFragment extends Fragment implements View.OnClickListener, SwipeRefreshLayout.OnRefreshListener, MyAdapter.itemClickListener {
    RecyclerView rv;
    MyAdapter adapter;
    ...
    public void getData() {
        ...
        CollectionReference enterntainment = db.collection("movie");
